...
# Kommentare bis auf vorgenommene Änderungen gleich
...
def depthFirstSearch(subTree, subTrees, swaps): # Prüfungen berücksichtigen keine Segmentanzahlen mehr, nur Umlegungen ...
